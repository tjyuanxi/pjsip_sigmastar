...
#endif
#define SND_UTIL_VERSION_STR "tj-1.1"
#ifndef LLONG_MAX
...
static void set_params(void)
{
	...
	printf("1111111111:rate:hwparams.format:%d\n", hwparams.format);
	...
	printf("22222222222:rate:hwparams.channels:%d\n", hwparams.channels);
	...
	period_frames = 160;
	buffer_frames = 1120;
	printf("44444444444:period_time:%d, period_frames:%d, buffer_time:%d, buffer_frames:%d\n", period_time, period_frames, buffer_time, buffer_frames);
	// if (period_time > 0)
