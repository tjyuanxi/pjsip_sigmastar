                                ...
                                pjsip_rx_data *rdata)
{
	...
	//msg_data.msg_body = pj_str(rdata->msg_info.msg_buf);

	pjsua_call_answer(call_id, PJSIP_SC_RINGING, NULL, &msg_data);
